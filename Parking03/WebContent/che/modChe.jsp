...
function up() {
	...
	<td>
		<input class="common-text required"  value="<%=che.getHao()%>" id="hao" name="hao"
			size="50"  type="text">
	</td>
</tr>
...
<tr>
	...
	<td>
		<input class="common-text required"  value="<%=che.getLeixing()%>" id="leixing" name="leixing"
			size="50"  type="text">
	</td>
</tr>
...
<tr>
	...
	<td>
		<input class="common-text required"  value="<%=che.getInfo()%>" id="info" name="info"
			size="50"  type="text">
	</td>
</tr>
					<%
...
function save() {	
	...
	document.forms[0].action = "<%=path%>/ModCheServlet";	
